...
public class RenderLightningBolt extends Render
{
     ...
     */
    public void doRenderLightningBolt(LightningBolt lightningBolt, double x, double y, double z, float rY, float rP)
    {
        ...
        double d3 = 0.0D;
        double d4 = 0.0D;
        Random random = new Random(lightningBolt.boltVertex);
        ...
        for (int j = 0; j < 4; ++j)
        {
            Random random1 = new Random(lightningBolt.boltVertex);
            ...
            for (int k = 0; k < 3; ++k)
            {
                ...
                for (int j1 = l; j1 >= i1; --j1)
                {
                    ...
                    for (int k1 = 0; k1 < 5; ++k1)
                    {
                        ...
                        tessellator.addVertex(d13 + d5, y + (double)(j1 * 16), d14 + d6);
                        tessellator.addVertex(d11 + d7, y + (double)((j1 + 1) * 16), d12 + d8);
                    }
    ...
    {
        this.doRenderLightningBolt((LightningBolt)par1Entity, par2, par4, par6, par8, par9);
    }
}
